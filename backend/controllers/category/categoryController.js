...
const fetchCategorysController = expressAsyncHandler(async (req,res) => {
    try {
...
module.exports = {createCategoryController,fetchCategorysController,fetchCategoryController,updateCategoryController,deleteCategoryController }